...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/+6287812264674"
    echo -e "\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    exit 0
  fi
}
...
source /etc/os-release
    if [ -f "/usr/bin/apt-get" ];then
        ...
        echo "contact person t.me/AJW29"
        sleep 3s
        exit
    fi
}
...
mkdir -p /var/lib/fanstore >/dev/null 2>&1
echo "IP=" >> /var/lib/fanstore/ipvps.conf
...
mkdir -p /etc/fanstoresugoitensai
mkdir -p /etc/fanstoresugoitensai/limit
mkdir -p /etc/fanstoresugoitensai/limit/trojan
mkdir -p /etc/fanstoresugoitensai/limit/vless
mkdir -p /etc/fanstoresugoitensai/limit/vmess
mkdir -p /etc/fanstoresugoitensai/limit/shadowsocks
mkdir -p /etc/fanstoresugoitensai/limit/ssh
mkdir -p /etc/fanstoresugoitensai/limit/ssh/ip
mkdir -p /etc/fanstoresugoitensai/limit/trojan/ip
mkdir -p /etc/fanstoresugoitensai/limit/trojan/quota
mkdir -p /etc/fanstoresugoitensai/limit/vless/ip
mkdir -p /etc/fanstoresugoitensai/limit/vless/quota
mkdir -p /etc/fanstoresugoitensai/limit/vmess/ip
mkdir -p /etc/fanstoresugoitensai/limit/vmess/quota
mkdir -p /etc/fanstoresugoitensai/limit/shadowsocks/ip
mkdir -p /etc/fanstoresugoitensai/limit/shadowsocks/quota
mkdir -p /etc/fanstoresugoitensai/trojan
mkdir -p /etc/fanstoresugoitensai/vless
mkdir -p /etc/fanstoresugoitensai/vmess
mkdir -p /etc/fanstoresugoitensai/shadowsocks
mkdir -p /etc/fanstoresugoitensai/log
mkdir -p /etc/fanstoresugoitensai/log/trojan
mkdir -p /etc/fanstoresugoitensai/log/vless
mkdir -p /etc/fanstoresugoitensai/log/vmess
mkdir -p /etc/fanstoresugoitensai/log/shadowsocks
mkdir -p /etc/fanstoresugoitensai/log/ssh
mkdir -p /etc/fanstoresugoitensai/cache

mkdir -p /etc/fanstoresugoitensai/cache/trojan-tcp

mkdir -p /etc/fanstoresugoitensai/cache/trojan-ws
mkdir -p /etc/fanstoresugoitensai/cache/trojan-grpc
mkdir -p /etc/fanstoresugoitensai/cache/shadowsocks-ws
mkdir -p /etc/fanstoresugoitensai/cache/shadowsocks-grpc
mkdir -p /etc/fanstoresugoitensai/cache/vless-ws
mkdir -p /etc/fanstoresugoitensai/cache/vless-grpc
mkdir -p /etc/fanstoresugoitensai/cache/vmess-ws
mkdir -p /etc/fanstoresugoitensai/cache/vmess-grpc
mkdir -p /etc/fanstoresugoitensai/cache/vmess-ws-orbit
mkdir -p /etc/fanstoresugoitensai/cache/vmess-ws-orbit1
}

function fixtema(){
rm -rf /etc/fanstore/theme > /dev/null 2>&1
    if [ -f "/etc/fanstore/theme/blue" ]; then
        #echo "sudah ada tema, mulai proses over write"
        rm -rf /etc/fanstore/theme
        mkdir -p /etc/fanstore
        mkdir -p /etc/fanstore/theme
    else
...
#THEME RED
cat <<EOF>> /etc/fanstore/theme/red
BG : \E[40;1;41m
TEXT : \033[0;31m
EOF
#THEME BLUE
cat <<EOF>> /etc/fanstore/theme/blue
BG : \E[40;1;44m
TEXT : \033[0;34m
EOF
#THEME GREEN
cat <<EOF>> /etc/fanstore/theme/green
BG : \E[40;1;42m
TEXT : \033[0;32m
EOF
#THEME YELLOW
cat <<EOF>> /etc/fanstore/theme/yellow
BG : \E[40;1;43m
TEXT : \033[0;33m
EOF
#THEME MAGENTA
cat <<EOF>> /etc/fanstore/theme/magenta
BG : \E[40;1;43m
TEXT : \033[0;33m
EOF
#THEME CYAN
cat <<EOF>> /etc/fanstore/theme/cyan
BG : \E[40;1;46m
TEXT : \033[0;36m
EOF
#THEME CONFIG
cat <<EOF>> /etc/fanstore/theme/color.conf
blue
EOF
}
function iptabless(){
...
<font color="red"><b>********  Fan Store  ********</b></font><br>
<font color="blue"><b>===============================</br></font><br>
END
}
SystemOperasi
